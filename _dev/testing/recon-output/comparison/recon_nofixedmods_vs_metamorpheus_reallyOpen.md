# Mod-discovery cross-comparison: Sage-Recon vs MetaMorpheus (reallyOpen, GPTMD-confirmed)
...
### bcell  (Sage-Recon vs MetaMorpheus (reallyOpen, GPTMD-confirmed))

- Matched (both, within 0.015 Da): **16**
- Sage-Recon only: **31**
- MetaMorpheus (reallyOpen, GPTMD-confirmed) only: **28**
...
| mass (Da) | Sage-Recon label | Recon % | Recon rank | MetaMorpheus (reallyOpen, GPTMD-confirmed) label | MetaMorpheus (reallyOpen, GPTMD-confirmed) % | MetaMorpheus (reallyOpen, GPTMD-confirmed) rank |
|---|---|---|---|---|---|---|
...
**MetaMorpheus (reallyOpen, GPTMD-confirmed) only (in window, no match):**
...
### serum  (Sage-Recon vs MetaMorpheus (reallyOpen, GPTMD-confirmed))

- Matched (both, within 0.015 Da): **17**
- Sage-Recon only: **31**
- MetaMorpheus (reallyOpen, GPTMD-confirmed) only: **31**
...
### b1906  (Sage-Recon vs MetaMorpheus (reallyOpen, GPTMD-confirmed))

- Matched (both, within 0.015 Da): **17**
- Sage-Recon only: **31**
- MetaMorpheus (reallyOpen, GPTMD-confirmed) only: **24**
