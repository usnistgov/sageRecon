# Mod-discovery cross-comparison: Sage-Recon vs MetaMorpheus (GPTMD-confirmed)
...
### bcell  (Sage-Recon vs MetaMorpheus (GPTMD-confirmed))

- Matched (both, within 0.015 Da): **16**
- Sage-Recon only: **31**
- MetaMorpheus (GPTMD-confirmed) only: **28**
...
| mass (Da) | Sage-Recon label | Recon % | Recon rank | MetaMorpheus (GPTMD-confirmed) label | MetaMorpheus (GPTMD-confirmed) % | MetaMorpheus (GPTMD-confirmed) rank |
|---|---|---|---|---|---|---|
...
**MetaMorpheus (GPTMD-confirmed) only (in window, no match):**
...
### serum  (Sage-Recon vs MetaMorpheus (GPTMD-confirmed))

- Matched (both, within 0.015 Da): **17**
- Sage-Recon only: **31**
- MetaMorpheus (GPTMD-confirmed) only: **31**
...
### b1906  (Sage-Recon vs MetaMorpheus (GPTMD-confirmed))

- Matched (both, within 0.015 Da): **17**
- Sage-Recon only: **31**
- MetaMorpheus (GPTMD-confirmed) only: **24**
