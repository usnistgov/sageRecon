...
# Crystal-C version 1.5.9
# MSBooster version 1.3.17
# Percolator version 3.7.1
# PTMProphet version 7.3.0
# Metaproteomics version 1.0.1
# Philosopher version 5.1.2
# PTM-Shepherd version 3.0.2
...
database.db-path=<redacted>/Documents\\temp\\delme\\sagePreview\\liver\\2026-08-31-decoys-uniprot_sprot_iso_human-2018_06.fasta.fas
...
fragpipe-config.bin-diann=C\:\\FragPipe\\FragPipe-23.1\\tools\\diann\\1.8.2_beta_8\\windows\\DiaNN.exe
fragpipe-config.bin-python=C\:\\FragPipe\\FragPipe-23.1\\python\\python.exe
fragpipe-config.tools-folder=C\:\\FragPipe\\FragPipe-23.1\\tools
freequant.mz-tol=10
...
workdir=<redacted>/Documents\\temp\\delme\\sagePreview\\liver\\reallyOpenShepherd
